                ...
                <div className="contact-grid">
                    <div className="contact-info reveal">
                        ...
                        <div className="contact-links">
                            ...
                            <a href="https://github.com/DeathSHMASHER" target="_blank" rel="noopener noreferrer" className="contact-link liquid-glass liquid-glass-continuous" style={{ '--shimmer-delay': '2s' }}>
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <div className="cl-value">DeathSHMASHER</div>
                                </div>
                            </a>
                        </div>
                    </div>
